...
<html lang="en">
    <head>
        ...
        <title>Khazar Newsportal | Add Category</title>
...
<strong>Finished adding</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
<!---Error Message--->
<?php if($error){ ?>
<div class="alert alert-danger" role="alert">
<strong>Oh there were some errors!</strong> <?php echo htmlentities($error);?></div>
<?php } ?>
</div>
</div>
                        			<div class="row">
